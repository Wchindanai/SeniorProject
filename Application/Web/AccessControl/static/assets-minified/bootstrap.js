...
function body_sizer() {
    if ($("body").hasClass("fixed-sidebar")) {
        ...
        var a = $(document).height(), b = $("#page-header").height(), c = a - b;
        $("#page-sidebar").css("height", c), $(".scroll-sidebar").css("height", c), $("#page-content").css("min-height", c)
    }
}
function pageTransitions() {
    ...
    for (var b in a) {
        ...
        if ($(".add-transition").hasClass(c))
            return $(".add-transition").addClass(c + "-init page-transition"), void setTimeout(function() {
...
+ function(a) {
    ...
    var b = function() {
        var b = {
            ...
            var c, d = a(this), e = d.siblings(".sidebar-submenu");
        ...
        return {
            hide: function(b) {
                if (this.length) {
                    ...
                    if (!d)
                        return this;
                    var e = d.retainPath===!0 ? d.$path: "", f = c.find("li." + d.activeClass).add(this).not(e).removeClass(d.activeClass).children(".sidebar-submenu"), g = d.speedOut;
            ...
            show: function() {
                ...
                if (!a)
                    return this;
                var b = this.addClass(a.activeClass), c = b.children(".sidebar-submenu");
            ...
            destroy: function() {
                return this.each(function() {
                    var d = a(this), g = d.data("sf-options"), h = d.find("li:has(ul)");
            ...
            reset: function() {
                return this.each(function() {
                    var b = a(this), c = l(b), d = a(b.find("." + c.activeClass).toArray().reverse());
            ...
            init: function(h) {
                return this.each(function() {
                    var i = a(this);
                    if (i.data("sf-options"))
                        return !1;
                    var j = a.extend({}, a.fn.superclick.defaults, h), k = i.find("li:has(ul)");
    ...
    a.easyPieChart = function(b, c) {
        ...
        return this.el = b, this.$el = a(b), this.$el.data("easyPieChart", this), this.init = function() {
            ...
            var a, b, c;
            for (l.ctx.fillStyle = l.options.scaleColor, l.ctx.lineWidth = 1, c = [], a = b = 0; 24 >= b; a=++b)
                c.push(d(a));
            return c
        }, d = function(a) {
            var b;
...
$(document).ready(function() {
    ...
    a.slidebars = function(b) {
        ...
        function e(a, b, c) {
            var e;
            if (e = a.hasClass("sb-style-push") ? q.add(a).add(y) : a.hasClass("sb-style-overlay") ? a : q.add(y), "translate" === z)
                e.css("transform", "translate(" + b + ")");
            else if ("side" === z)
                "-" === b[0] && (b = b.substr(1)), "0px" !== b && e.css(c, "0px"), setTimeout(function() {
                    e.css(c, b)
                }, 1);
            else if ("jQuery" === z) {
                "-" === b[0] && (b = b.substr(1));
        ...
        }, b), k = document.createElement("div").style, l=!1, m=!1;
        ...
        var n = navigator.userAgent, o=!1, p=!1;
        ...
        if (a(".sb-right").length)
            var t = a(".sb-right"), u=!1;
        var v=!1, w = a(window).width(), x = a(".sb-toggle-left, .sb-toggle-right, .sb-open-left, .sb-open-right, .sb-close"), y = a(".sb-slide");
    ...
    $(".overlay-button").click(function() {
        var a = $(this).attr("data-theme"), b = $(this).attr("data-opacity"), c = $(this).attr("data-style"), d = '<div id="loader-overlay" class="ui-front loader ui-widget-overlay ' + a + " opacity-" + b + '"><img src="../../assets/images/spinner/loader-' + c + '.gif" alt="" /></div>';
        ...
        var b = $(this).parents(".content-box"), c = $(this).attr("data-theme"), d = $(this).attr("data-opacity"), e = $(this).attr("data-style"), f = '<div id="refresh-overlay" class="ui-front loader ui-widget-overlay ' + c + " opacity-" + d + '"><img src="../../assets/images/spinner/loader-' + e + '.gif" alt="" /></div>';
...
document.getElementById("fullscreen-btn") && document.getElementById("fullscreen-btn").addEventListener("click", function() {
    ...
    pageTransitions(), $(".dropdown").on("show.bs.dropdown", function(a) {
        ...
        a = a[a.length - 1], void 0 !== a && ($("#sidebar-menu").find("a[href$='" + a + "']").addClass(""), $("#sidebar-menu").find("a[href$='" + a + "']").parents().eq(3).superclick("show"))
    }), $(function() {
